// DELETE - v1/users/{upmId}/inquiryParticipations/{id}
import axios from "axios"
import { vars, headers } from "../../../../../helpers/variables.js"
import assert from "assert"

describe("DELETE - v1/users/{upmId}/inquiryParticipations/{id}", () => {
    ...
    it("Deletes a user inquiry participation", async () => {
        ...
        let response
        try {
            response = await axios.delete(`${env}/v1/users/${vars.upmId}/inquiryParticipations/${id}`,
            { headers: headers})
