// PATCH - v1/users/{upmId}/inquiryParticipations/{id}
import axios from "axios"
import { headers, vars } from "../../../../../helpers/variables.js"
import assert from "assert"

describe("PATCH - v1/users/{upmId}/inquiryParticipations/{id}", () => {
    ...
    it("Updates a user inquiry participation", async () => {
        ...
        try {
            response = await axios.patch(`${env}/v1/users/${vars.upmId}/inquiryParticipations/${id}`, {
                "upmId": vars.upmId,
                "inquiryHandle": "",
                "status": "",
                "customKey": "",
