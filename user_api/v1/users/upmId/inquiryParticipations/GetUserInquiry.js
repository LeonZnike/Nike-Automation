// GET - v1/users/{upmId}/inquiryParticipations/{id}
import axios from "axios"
import { headers } from "../../../../../helpers/variables.js"
import assert from "assert"

describe("GET - v1/users/{upmId}/inquiryParticipations/{id}", () => {
    ...
    it("Returns the audiences users", async () => {
        ...
        try {
            response = await axios.get(`${env}/v1/users/${vars.upmId}/inquiryParticipations/${id}`, 
            { headers: headers})
        } catch (error) {
            // console.error(error)
            // throw error
