// PATCH - v1/users/{upmId}/deepLinks/{handle}
import axios from "axios"
import { headers, vars } from "../../../../../helpers/variables.js"
import assert from "assert"

describe("PATCH - v1/users/{upmId}/deepLinks/{handle}", () => {
    ...
    it("Updates a users deepLinks", async () => {
        ...
        try {
            response = await axios.patch(`${env}/v1/users/${vars.upmId}/deepLinks/${handle}`, {
                "url": "",
                "handle": ""
            },
        {headers: headers})
