// GET - v1/users/current/inquiryParticipations/{inquiryHandle/customKey/{customKey}
import axios from "axios"
import { headers, vars } from "../../../../../helpers/variables.js"
import assert from "assert"

describe("GET - v1/users/current/inquiryParticipations/{inquiryHandle/customKey/{customKey}", () => {
    ...
    it("Returns the users inquiry participation using their customKey", async () => {
        ...
        try {
            response = await axios.get(`${env}/v1/users/current/inquiryParticipations/${vars.inquiryHandle}/customKey/${customKey}`, 
            {headers: headers})
