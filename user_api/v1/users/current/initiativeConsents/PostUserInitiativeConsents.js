// POST - v1/users/current/initiativeConsents
import axios from "axios"
import { headers } from "../../../../../helpers/variables.js"
import assert from "assert"

describe("POST - v1/users/current/initiativeConsents", () => {
    ...
    it("Adds a user initiative Consents", async () => {
        ...
        let response
        try {
            response = await axios.post(`${env}/v1/users/current/initiativeConsents`, {
