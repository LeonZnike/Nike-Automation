// DELETE - v1/users/current/deepLinks/{handle}
import axios from "axios"
import { vars, headers } from "../../../../../helpers/variables.js"
import assert from "assert"

describe("DELETE - v1/users/current/deepLinks/{handle}", () => {
    ...
    it("Deletes a user deepLink", async () => {
        ...
        try {
            response = await axios.delete(`${env}/v1/users/current/deepLinks/${handle}`,
            { headers: headers})
